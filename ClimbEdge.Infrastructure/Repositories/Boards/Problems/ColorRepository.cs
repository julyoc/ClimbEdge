...
{
    public class ColorRepository(ClimbEdgeContext climbEdgeContext, ICacheService cacheService) : Repository<Color>(climbEdgeContext, cacheService), IColorRepository
    {
    }
}
