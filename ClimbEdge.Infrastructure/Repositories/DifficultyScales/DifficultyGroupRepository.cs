...
{
    public class DifficultyGroupRepository(ClimbEdgeContext climbEdgeContext, ICacheService cacheService) : Repository<DifficultyGroup>(climbEdgeContext, cacheService), IDifficultyGroupRepository
    {
    }
}
