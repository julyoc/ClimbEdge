...
{
    public class DifficultyScaleTypeRepository(ClimbEdgeContext climbEdgeContext, ICacheService cacheService) : Repository<DifficultyScaleType>(climbEdgeContext, cacheService), IDifficultyScaleTypeRepository
    {
    }
}
