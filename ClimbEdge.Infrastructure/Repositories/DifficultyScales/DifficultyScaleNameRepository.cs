...
{
    public class DifficultyScaleNameRepository(ClimbEdgeContext climbEdgeContext, ICacheService cacheService) : Repository<DifficultyScaleName>(climbEdgeContext, cacheService), IDifficultyScaleNameRepository
    {
    }
}
