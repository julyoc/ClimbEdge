...
{
    internal static class BaseModelConfiguration
    {
        public static EntityTypeBuilder<T> ConfigureBaseModel<T>(this EntityTypeBuilder<T> builder) where T : BaseModel
        {
            // Configurar propiedades comunes de BaseModel
